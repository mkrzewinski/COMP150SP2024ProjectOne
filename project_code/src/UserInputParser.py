        ...
        if self.login(username, password):
            ...
            if ans.lower() == 'yes':
                ...
                if random.random() < 0.5:  # 50% chance of winning
                    ...
                    self.earn_legacy_points(self.username, 100)  # Example: Award legacy points for winning
                    ...
                    self.spend_legacy_points(self.username, 50)  # Example: Deduct legacy points for losing
...
def main():
    while True:
        ...
        game_instance = Game(username)  # Pass the username to the Game constructor
